...
class TestUT_ATT_16(TestCase):
    def test_UT_ATT_16(self):
        ...
        klass = Class.objects.create(code='C016', name='Test Class 16', center=center, subject=subject, room=room)
        session = ClassSession.objects.create(klass=klass, index=16)
        teacher = User.objects.create_user(username='teacher16', password='pass', role='Teacher')
