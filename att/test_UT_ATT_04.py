...
class TestUT_ATT_04(TestCase):
    def test_UT_ATT_04(self):
        ...
        klass = Class.objects.create(code='C004', name='Test Class 4', center=center, subject=subject, room=room)
        session = ClassSession.objects.create(klass=klass, index=4)
        teacher = User.objects.create_user(username='teacher4', password='pass', role='Teacher')
        ...
        self.assertEqual(att2.status, 'A')
